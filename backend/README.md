...
## Project Structure
    ...
    ├── testapiautocatalog_111479  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111479`
...
2. Clone this repo and `cd testapiautocatalog_111479`
